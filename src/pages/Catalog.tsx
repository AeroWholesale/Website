...
const css = `
  ...
  .aw-search-input { width: 100%; height: 42px; padding: 0 14px 0 42px; border: 1px solid #e2e8f0; border-radius: 8px; font-size: 14px; font-family: 'DM Sans', sans-serif; color: #0f172a; background: #f8fafc; outline: none; transition: border-color 0.15s, background 0.15s; box-sizing: border-box; }
  ...
  .aw-card-footer { border-top: 1px solid #e2e8f0; padding-top: 12px; margin-top: auto; display: flex; align-items: center; justify-content: space-between; }
  ...
  @media (max-width: 1024px) {
    .aw-cat-layout { grid-template-columns: 1fr; padding: 20px; }
  ...
  @media (max-width: 640px) {
    .aw-products-grid { grid-template-columns: 1fr; }
        ...
        <div className="aw-search-bar">
          <div className="aw-search-inner">
            <div className="aw-search-wrap">
              <IconSearch />
              <input className="aw-search-input" placeholder="Search by model, SKU, brand..." value={searchInput} onChange={e => setSearchInput(e.target.value)} />
            </div>
